...
namespace eth {
	...
	namespace fields {
		...
		// page 1157
		namespace tdes3 {
			// Transmit buffer 2 address pointer / next descriptor address / Transmit frame time stamp high
	...
	// When you have multiple descriptors contiguous (or by a configurable offset, field dsl in register dmabmr)
	// in memory, you don't have to use the second address as a chain-next link
	// so you can use 2 data buffers per descriptor. (This is called implicit chaining).
	// In this case the last descriptor has to set the "receive end of ring, rer" in rdes1.
	...
	struct EmbeddingTxDmaFrame : public tx_dma_descriptor {
		EmbeddingTxDmaFrame() {
			...
			this->tdes0 = tdes0::own(0) | tdes0::ic(0)  | tdes0::ls(0)   | tdes0::fs(0)  |
						  tdes0::dc(0)  | tdes0::dp(0)  | tdes0::ttse(0) | tdes0::cic(3) |
						  tdes0::ter(0) | tdes0::tch(0) | tdes0::ttss(0) | tdes0::ihe(0) |
						  tdes0::es(0)  | tdes0::jt(0)  | tdes0::ff(0)   | tdes0::ipe(0) |
						  tdes0::lca(0) | tdes0::nc(0)  | tdes0::lco(0)  | tdes0::ec(0)  |
						  tdes0::vf(0)  | tdes0::cc(0)  | tdes0::ed(0)   | tdes0::uf(0)  |
						  tdes0::db(0);
